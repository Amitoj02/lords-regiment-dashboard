...
const STUB_EVENTS: RegimentEvent[] = [
  {
    ...
    description: 'Weekly organised line battle against allied regiments. Full uniform required. Officers to coordinate flanks.',
  ...
  },
  {
    ...
    description: 'Command and communication drill for officers and NCOs. Mandatory for promotions.',
  ...
  },
  {
    ...
    description: 'Open server event for prospective members. Show off our drill and discipline.',
